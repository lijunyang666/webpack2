...
var updatePass = Vue.extend({
     ...
     // +'<div class="numberAItwo1"><span class="name1">旧密码：</span><input type="" name="" id="" value="" /></div>'
      +'<div class="numberAItwo2"><span class="name1">新密码：</span><input type="password" v-model="passWord" /><span class="remark1">密码由6-16个字符组成，区分大小写（不能是9位一下的纯数字，不能包含空格）</span></div>'
