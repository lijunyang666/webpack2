...
var wallet = Vue.extend({
      ...
      +'<div class="content"><div class="bookBlockList" ><div class="bookBlockList_title"><span class="hr"></span><span class="title">支付账单</span><span class="titleTwo">pay treasure bills</span></div><div class="pay-head">    钱包明细</div><ul class="pay-income"><li>可用余额:</li><li class="money" v-if="exchangeableCashAmount >= 1">￥{{ exchangeableCashAmount }}</li><li class="money" v-else>￥0.00</li><li>冻结余额:</li><li class="money" v-if="freezeCashAmount >= 1">￥{{ freezeCashAmount}}</li><li class="money" v-else>￥0.00</li><li class="goodman">提现余额:</li><li class="money" v-if="totalAmount >=1 ">￥{{ totalAmount }}</li><li class="money" v-else >￥0.00</li></ul><ul class="pay-a"><li>日期</li><li>收入</li><li>支出</li><li>详情</li></ul><hr style="border: 1px solid #E1E1E1; margin:0 0 0 5%;" width="90%" /><div class="table-a"><table  border="0" cellspacing="0" cellpadding="0"><tbody  ><tr v-for="obj in list"><td>{{ szxj.getLocalTimeTwo(obj.createTime) }}</td><td v-if=" data.userName == obj.paiedUserName ">+{{ obj.exchangeableCashAmount + obj.unexchangeableCashAmount + obj.welfareCashAmount }}</td><td v-else>--</td><td v-if=" data.userName !== obj.paiedUserName ">-{{ obj.exchangeableCashAmount + obj.unexchangeableCashAmount + obj.welfareCashAmount }}</td><td v-else>--</td><td v-if="obj.typeDescription == 2100 && obj.orderStatus == 0">申请提现中</td><td v-if="obj.typeDescription == 2100 && obj.orderStatus == 1">提现完成&nbsp<a title="福利金额：{{obj.welfareCashAmount}}&#10;提现金额：{{obj.exchangeableCashAmount}}&#10;不可提现金额：{{obj.unexchangeableCashAmount}}"><img class="icon_001" src="../img/icon_001.png"/></a></td><td v-if="obj.typeDescription == 2101" >充值</td><td v-if="obj.typeDescription == 2102  ">购买好人卡&nbsp<a  title="福利金额：{{obj.welfareCashAmount}}&#10;提现金额：{{obj.exchangeableCashAmount}}&#10;不可提现金额：{{obj.unexchangeableCashAmount}}"><img class="icon_001" src="../img/icon_001.png"/></a></td><td v-if="obj.typeDescription == 2103  ">绘画作品订金&nbsp<a title="福利金额：{{obj.welfareCashAmount}}&#10;提现金额：{{obj.exchangeableCashAmount}}&#10;不可提现金额：{{obj.unexchangeableCashAmount}}"><img class="icon_001" src="../img/icon_001.png"/></a></td><td v-if="obj.typeDescription == 2104  ">上月福利金额清零&nbsp<a title="福利金额：{{obj.welfareCashAmount}}&#10;提现金额：{{obj.exchangeableCashAmount}}&#10;不可提现金额：{{obj.unexchangeableCashAmount}}"><img class="icon_001" src="../img/icon_001.png"/></a></td><td v-if="obj.typeDescription == 2105">小说作品稿费</td><td v-if="obj.typeDescription == 2107">绘画作品稿费</td><td v-if="obj.typeDescription == 2109">每月福利金额</td></tr></tbody></table></div><ul class="totle_money"><li>合计&nbsp:</li><li>{{totalIncome}}&nbsp元</li><li>{{totalpay}}&nbsp元</li></ul><hr style="border: 1px solid #E1E1E1; margin:0 0 0 5%;" width="90%" />'
...
//      },
        ...
        getBookListFn: function() {
          ...
          SZXJ.http(this,'get', PathList.amount, {}, (response) => {
            ...
            this.freezeCashAmount = response.data.amount.freezeCashAmount ;
          });
