       ...
       SubmitgoodmenFnTow:function(){
        ...
        getBookListFn: function() {
          ...
          SZXJ.http(this,'get', PathList.amount, {}, (response) => {
            ...
            this.name = response.data.amount.realName;
