...
var bill = Vue.extend({
      ...
      +'<ul class="nav"><li class="active" v-link="{path: \'/bill\'}"><span class="circular"></span><span class="title_name">我的账单</span></li><li  v-link="{path: \'/wallet\'}"><span class="circular"></span><span class="title_name">我的钱包</span></li><li  v-link="{path: \'/goodmen\'}"><span class="circular"></span><span class="title_name">我的好人卡</span></li></ul>'
      ...
      methods: {
       ...
       rechargeFn:function(){
         ...
         this.$set('isTru', true);
          var _data={};
          _data.amountNumber = this.amountNumber;
