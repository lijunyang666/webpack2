...
var bill = Vue.extend({
      ...
      +'<div v-if="exchangeFlag"  class="exchange"><span class="exchange_span">请选择兑换金额:</span><ul class="exchange_ul"><li>1元</li><li>5元</li><li>10元</li><li>20元</li><li>50元</li><li>100元</li><li>200元</li><li>500元</li></ul><div class="exchange_divOne"><span class="exchange_div_span">需拥有700好人卡</span></div><div class="exchange_div"><span>其他金额</span><input type="" name="" id="" value="" />元</div><span class="exchange_spanTow">我的好人卡：0</span><div class="exchange_divTow" @click="SubmitexchangeFn">兑换</div><div class="exchange_divTow" @click="SubmitexchangeFn">取消</div><span class="exchange_divTow_spanTow" @click="goodmenFn">>>好人卡充值</span></div>'
      +'<div v-if="goodmenFlag" class="exchange"><span class="exchange_span">请选择兑换数量:</span><ul class="exchange_ul"><li>×100</li><li>×200</li><li>×500</li><li>×1000</li><li>×3000</li><li>×5000</li><li>×10000</li></ul><div class="exchange_divOne"><span class="exchange_div_span">需拥有余额100</span></div><div class="exchange_div"><span>其他数量</span><input type="" name="" id="" value="" />张</div><span class="exchange_spanTow">我的余额：0</span><div class="exchange_divTow" @click="SubmitgoodmenFn">购买</div><div class="exchange_divTow" @click="SubmitgoodmenFn">取消</div><span class="exchange_divTow_spanTow" @click="exchangeFn">>>兑换余额</span></div>'
      +'<div v-if="moneyRecharge" class="moneyRecharge">  <div class="moneyRecharge_header">账户余额充值</div>  <div class="moneyRecharge_name" >昵称&nbsp:<input type="text" /></div>   <div class="moneyRecharge_name" >账号&nbsp:<input type="text" /></div>   <div class="moneyRecharge_number" >充值金额&nbsp:<input type="text" v-model="amount" />元</div>   <div class="moneyRecharge_pay" > <span class="moneyRecharge_choose">支付方式:</span><input type="radio" checked="checked"/><div class="moneyRecharge_img"></div>  </div>  <div class="moneyRecharge_div" @click="SubmitmoneyRechargeFn" >确认</div>  <div class="moneyRecharge_div" @click="SubmitmoneyRechargeFn">取消</div> </div>'
      ...
      methods: {
        ...
        getBookListFn: function() {
          ...
          SZXJ.http(this,'get', PathList.recharge, amount, (response) => {
