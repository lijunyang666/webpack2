...
function(a) {
	"function" == typeof window.define ?
  	...
  	window.define.amd ? 
    	...
    	window.define("wangEditor", ["jquery"], a) : window.define.cmd ? 
    	window.define(function(b, c, d) { return a }) : a(window.jQuery) : "object" == typeof module && "object" == typeof module.exports ?
    	(window.wangEditorCssPath ? require(window.wangEditorCssPath) : require("../css/wangEditor.min.css"), module.exports = a(window.wangEditorJQueryPath ? 
    	  
    	  require(window.wangEditorJQueryPath)
	...
	return function(a, b) {
		...
		var c = function(a) {
			...
			var c = b(a);
			if (1 === c.length) {
				var d = c[0].nodeName; ("TEXTAREA" === d || "DIV" === d) && (this.valueNodeName = d.toLowerCase(), this.$valueContainer = c, this.$prev = c.prev(), this.$parent = c.parent(), this.init())
			}
		};
		c.fn = c.prototype,
		c.$body = b("body"),
		...
		c.websiteHost = "wangeditor.github.io",
		c.isOnWebsite = c.hostname === c.websiteHost,
	...
	b(function(a, b) {
		...
		a.fn.getRangeText = d ? c: function(a) {
			return (a = a || this.currentRange()) ? a.toString() : void 0
		},
		...
		a.fn.isRangeEmpty = d ? c: function(a) {
			...
			a && a.startContainer && a.startContainer === a.endContainer && a.startOffset === a.endOffset ? !0 : !1
		},
	...
	b(function(a, b) {
		a.w3cRange || (a.fn.getRangeText = function(a) {
			return (a = a || this.currentRange()) ? a.text: void 0
		},
	...
	b(function(a, b) {
		...
		c.fn.focusFirstInput = function() {
			...
			c.find("input[type=text],textarea").each(function() {
				var a = b(this);
				return null == a.attr("disabled") ? (a.focus(), !1) : void 0
			})
		},
		c.fn.show = function() {
			var b = this,
		...
		c.fn.bindPasteFilter = function() {
			function a(e) {
				if (e && e.nodeType && e.nodeName) {
					var f, h = e.nodeName.toLowerCase(),
					i = e.nodeType;
					if (3 === i || 1 === i) {
						if (f = b(e), "div" === h) return void b.each(e.childNodes,
						function() {
							a(this)
						});
						if (j.indexOf(h) >= 0) g += c(e);
						else if (3 === i) g += "<p>" + e.textContent + "</p>";
						else if ("br" === h) g += "<br/>";
						else {
							if (["meta", "style", "script", "object", "form", "iframe", "hr"].indexOf(h) >= 0) return;
							f = b(d(e)),
	...
	b(function(a, b) {
		...
		a.config.familys = ["宋体", "黑体", "楷体", "微软雅黑", "Arial", "Verdana", "Georgia", "Times New Roman", "Microsoft JhengHei", "Trebuchet MS", "Courier New", "Impact", "Comic Sans MS"],
		a.config.fontsizes = {
			1 : "10px",
			2 : "13px",
			3 : "16px",
	...
	b(function(a, b) {
		a.createMenu(function(c) {
			function d(a) {
				var b;
				return a && a.style && null != a.style.cssText && (b = a.style.cssText, b && b.indexOf("background-color:") >= 0) ? !0 : !1
			}
			var e = "bgcolor";
			if (c(e)) {
				var f = this,
		...
		a.createMenu(function(c) {
			...
			if (c(d)) {
				...
				g.updateSelectedEvent = function() {
					...
					function(a) {
						var c;
						return a && a.style && null != a.style.cssText && (c = a.style.cssText, c && /text-align:\s*left;/.test(c)) ? !0 : "left" === b(a).attr("align") ? !0 : !1
					}),
					a ? !0 : !1
				},
				e.menus[d] = g
		...
		a.createMenu(function(c) {
			...
			if (c(d)) {
				...
				g.updateSelectedEvent = function() {
					...
					function(a) {
						var c;
						return a && a.style && null != a.style.cssText && (c = a.style.cssText, c && /text-align:\s*center;/.test(c)) ? !0 : "center" === b(a).attr("align") ? !0 : !1
					}),
					a ? !0 : !1
				},
				e.menus[d] = g
		...
		a.createMenu(function(c) {
			...
			if (c(d)) {
				...
				g.updateSelectedEvent = function() {
					...
					function(a) {
						var c;
						return a && a.style && null != a.style.cssText && (c = a.style.cssText, c && /text-align:\s*right;/.test(c)) ? !0 : "right" === b(a).attr("align") ? !0 : !1
					}),
					a ? !0 : !1
				},
				e.menus[d] = g
	...
	b(function(a, b) {
		a.createMenu(function(c) {
			...
			if (c(d)) {
				...
				p = b("<span> 列</span>");
				for (f = 0; 15 > f; f++) {
					for (e = b('<tr index="' + (f + 1) + '">'), g = 0; 20 > g; g++) e.append(b('<td index="' + (g + 1) + '">'));
					l.append(e)
				}
				k.append(l),
				...
				function(a) {
					...
					l = "<table>";
					for (c = 0; j > c; c++) {
						for (l += "<tr>", d = 0; k > d; d++) l += "<td><span>&nbsp;</span></td>";
						l += "</tr>"
					}
					l += "</table>",
		...
		a.createMenu(function(c) {
			...
			if (c(d)) {
				...
				q.click(function(a) {
					...
					i = parseInt(n.val()),
					j = b("<div>"),
					l = '<p style="text-align:center;">{content}</p>';
		...
		a.createMenu(function(d) {
			...
			if (d(f)) {
				...
				window.baiduMapCallBack = function() {
					function b(b) {
						...
						p.on("keyup change paste", g), q.on("keyup change paste", g)) : (g = function() {
							...
							b = "",
							c = p.val(),
							d = q.val(); (c !== a || d !== b) && (k.searchMap(), a = c, b = d),
							f && clearTimeout(f),
							f = setTimeout(g, 1e3)
						},
						f = setTimeout(g, 1e3))
				...
				k.loadMapScript = function() {
					...
					b.src = "http://api.map.baidu.com/api?v=2.0&ak=" + j + "&callback=baiduMapCallBack";
					try {
				...
				m.clickEvent = function(a) {
					...
					c = b.dropPanel,
					d = !1;
					return c.isShowing ? void c.hide() : (k.map || (d = !0), k.initMap(), c.show(), void(d || q.focus()))
				}
			}
		})
	}),
	b(function(a, b) {
		...
		a.createMenu(function(d) {
			function e(a) {
				...
				a.append(c);
				var d = b("<div></div>"),
				e = b('<button class="right">' + i.submit + "</button>"),
				f = b('<button class="right gray">' + i.cancel + "</button>");
				d.append(e).append(f).append(n),
				a.append(d),
				f.click(function(a) {
					a.preventDefault(),
					k.dropPanel.hide()
				...
				e.click(function(a) {
					...
					a.preventDefault();
					var e = m.val();
					if (!e) return void m.focus();
					var f = h.getRangeElem();
					b.trim(b(f).text()) && (g = "<p><br></p>" + g);
					var i = n ? n.val() : "",
					l = "",
					o = function() {
						j.find("pre code").each(function(a, c) {
							var d = b(c);
							d.attr("codemark") || window.hljs && (window.hljs.highlightBlock(c), d.attr("codemark", "1"))
						})
					};
					if (i && (l = ' class="' + i + ' hljs"'), e = e.replace(/&/gm, "&amp;").replace(/</gm, "&lt;").replace(/>/gm, "&gt;"), !k.selected) {
						var p = g.replace("{#langClass}", l).replace("{#content}", e);
						return void h.command(a, "insertHtml", p, o)
					}
			...
			if (d(g)) {
				...
				k.clickEventSelected = function(a) {
					var c = this,
					d = c.dropPanel;
					if (d.isShowing) return void d.hide();
					d.show();
					...
					i && (e = b(i), m.val(e.text()), n && (f = e.attr("class"), f && n.val(f.split(" ")[0])))
				},
				k.updateSelectedEvent = function() {
					var a, b = this,
					c = b.editor;
					return a = c.getRangeElem(),
				...
				var l = b("<div></div>"),
				m = b("<textarea></textarea>"),
				n = b("<select></select>");
				e(l),
				k.dropPanel = new a.DropPanel(h, k, {
					$content: l,
					width: 500
				}),
				h.menus[g] = k,
	...
	b(function(a, b) {
		a.plugin(function() {
			function c() {
				l || (d(), m.append(n).append(o).append(p).append(q), h.$editorContainer.append(m), l = !0)
			}
			function d() {
				function a(a, c) {
					b && h.customCommand(a, b, c)
				}
				var b;
				o.click(function(c) {
					b = function() {
			...
			function e() {
				if (!h._disabled && null != g) {
					...
					0 > j ? (m.css("margin-left", "0"), n.hide()) : n.show()
				}
			}
			function f() {
				null != g && (g.removeClass("clicked"), g = null, m.hide())
			}
			var g, h = this,
			i = h.txt,
			j = i.$txt,
			k = h.useMaxHeight ? j.parent() : j,
			l = !1,
			m = b('<div class="txt-toolbar"></div>'),
			n = b('<div class="tip-triangle"></div>'),
			o = b('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'),
			p = b('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'),
			q = b('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>');
			k.on("click", "table",
			function(a) {
		...
		a.userAgent.indexOf("MSIE 8") > 0 || a.plugin(function() {
			function c(a, c) {
				if (j) {
					...
					d && k.customCommand(a, d, f)
				}
			}
			function d() {
				q || (e(), f(), u.append(v).append(w).append(x).append(y).append(z).append(A).append(B).append(C), D.append(E).append(G).append(F), s.append(t).append(u).append(D), k.$editorContainer.append(s).append(r), q = !0)
			}
			function e() {
				function a(a, b) {
					d && k.customCommand(a, d, b)
				}
				var d;
				v.click(function(b) {
					c(b, ""),
			...
			function f() {
				...
				r.on("mousedown",
				function(k) {
					j && (c = k.pageX, d = k.pageY, e = parseFloat(r.css("margin-left"), 10), f = parseFloat(r.css("margin-top"), 10), g = j.width(), i = j.height(), s.hide(), a.$document.on("mousemove._dragResizeImg", b), a.$document.on("mouseup._dragResizeImg",
					function(b) {
			...
			function g() {
				if (!k._disabled && null != j) {
					...
					0 > h ? (s.css("margin-left", "0"), t.hide()) : t.show(),
					k.disableMenusExcept()
				}
			}
			function h() {
				null != j && (j.removeClass("clicked"), j = null, s.hide(), r.hide(), k.enableMenusExcept())
			}
			function i(a) {
				var c = !1;
			...
			m = k.txt,
			n = m.$txt,
			o = k.useMaxHeight ? n.parent() : n,
			p = (k.$editorContainer, ""),
			q = !1,
			r = b('<div class="img-drag-point"></div>'),
			s = b('<div class="txt-toolbar"></div>'),
			t = b('<div class="tip-triangle"></div>'),
			u = b("<div></div>"),
			v = b('<a href="#"><i class="wangeditor-menu-img-trash-o"></i></a>'),
			w = b('<a href="#"><i class="wangeditor-menu-img-search-minus"></i></a>'),
			x = b('<a href="#"><i class="wangeditor-menu-img-search-plus"></i></a>'),
			y = b('<a href="#"><i class="wangeditor-menu-img-align-left"></i></a>'),
			z = b('<a href="#"><i class="wangeditor-menu-img-align-center"></i></a>'),
			A = b('<a href="#"><i class="wangeditor-menu-img-align-right"></i></a>'),
			B = b('<a href="#"><i class="wangeditor-menu-img-link"></i></a>'),
			C = b('<a href="#"><i class="wangeditor-menu-img-unlink"></i></a>'),
			D = b('<div style="display:none;"></div>'),
			E = b('<input type="text" style="height:26px; margin-left:10px; width:200px;"/>'),
			F = b('<button class="right">' + l.submit + "</button>"),
			G = b('<button class="right gray">' + l.cancel + "</button>"),
			H = !1;
			o.on("mousedown", "img",
			function(a) {
				a.preventDefault()
		...
		a.createMenu(function(c) {
			...
			if (c(d)) {
				...
				f.updateSelectedEvent = function() {
					...
					return f ? (a = b(f), c = a.css("text-indent"), c && "0px" !== c ? !0 : !1) : !1
				},
				e.menus[d] = f
			}
		})
